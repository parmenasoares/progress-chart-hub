...
import { ChevronLeft, ChevronRight, Calendar as CalendarIcon, List, Plus, User, Link as LinkIcon, Unplug, Bell, ExternalLink } from 'lucide-react';
...
const DEFAULT_CALENDLY_URL = 'https://calendly.com/samuraidebh';
...
export function Agenda({ patients, onUpdatePatient }: AgendaProps) {
  ...
  const openCalendlyForClient = (patient?: Patient) => {
    const baseUrl = import.meta.env.VITE_CALENDLY_URL || DEFAULT_CALENDLY_URL;
    ...
    <div className="flex-1">
      ...
      <div className="p-6 space-y-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex w-full flex-wrap items-center gap-2 lg:w-auto lg:justify-end">
            ...
            <Button variant="outline" size="sm" onClick={() => openCalendlyForClient()} className="w-full sm:w-auto">
              <ExternalLink className="h-4 w-4" />
              Calendly em 1 clique
            </Button>
      ...
      {showNewAppointment && (
        <NewAppointmentModal
          ...
          onOpenCalendly={(patientId) => {
            const patient = patients.find((p) => p.id === patientId);
            openCalendlyForClient(patient);
          }}
        />
      )}
    </div>
